...
<script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=" crossorigin="anonymous"></script>
  ...
  <body>
 <script src="/resources/js/materials/persistence/btn.js"></script>
  <script src="/resources/js/materials/persistence/details.js"></script>
  <script src="/resources/js/materials/persistence/list.js"></script>
  <script src="/resources/js/materials/persistence/search.js"></script>
   ...
   <div class="container">
    <section class="section1">
      ...
      <div class="list">
        <div class="list-btn">
          <button type="button" class="btn btn-secondary"  onclick="openModal()">추가</button>
