...
window.ActiveXObject
		...
		&& function(h, j) {
			...
			var k = null, r = "canvas", M = "CanvasRenderingContext2D", N = "CanvasGradient", O = "CanvasPattern", C = "FlashCanvas", P = "G_vmlCanvasManager", K = "onfocus", L = "onpropertychange", F = "onreadystatechange", J = "onunload", w = ((h[C
					+ "Options"] || {}).swfPath || V().replace(/[^\/]+$/, ""))
					+ "flashcanvas.swf", e = new function(a) {
				for (var b = 0, c = a.length; b < c; b++)
					this[a[b]] = b
			}([ "toDataURL", "save", "restore", "scale", "rotate", "translate",
					"transform", "setTransform", "globalAlpha",
					...
					"shadowBlur", "shadowColor", "clearRect", "fillRect",
					"strokeRect", "beginPath", "closePath", "moveTo", "lineTo",
					"quadraticCurveTo", "bezierCurveTo", "arcTo", "rect",
					"arc", "fill", "stroke", "clip", "isPointInPath", "font",
					"textAlign", "textBaseline", "fillText", "strokeText",
					"measureText", "drawImage", "createImageData",
			...
			u.prototype = {
				save : function() {
					...
					this.z();
					this.w();
					this.F.push([ this.f, this.g, this.A, this.u, this.j,
							this.h, this.i, this.k, this.p, this.q, this.n,
							this.o, this.v, this.r, this.s ]);
					this.a.push(e.save)
				},
				restore : function() {
					var a = this.F;
				...
				m : function() {
					if (this.A !== this.strokeStyle) {
						...
						this.a.push(e.strokeStyle, typeof a === "object" ? a.id
								: a)
					}
				},
				l : function() {
					if (this.u !== this.fillStyle) {
						...
						this.a.push(e.fillStyle, typeof a === "object" ? a.id
								: a)
					}
				},
				...
				createPattern : function(a, b) {
					...
					if (c) {
						...
						i(17);
					b === "repeat" || b === "no-repeat" || b === "repeat-x"
							|| b === "repeat-y" || b === "" || b === k || i(12);
				...
				w : function() {
					...
					if (this.v !== this.font)
						try {
							...
							a.push(e.font, [ c.fontStyle, c.fontWeight,
									b.offsetHeight, c.fontFamily ].join(" "))
						} catch (d) {
						}
				...
				fillText : function(a, b, c, d) {
					...
					this.c();
					this.w();
					this.a.push(e.fillText, v(a), b, c, d === void 0 ? Infinity
							: d)
				},
				strokeText : function(a, b, c, d) {
					...
					this.c();
					this.w();
					this.a.push(e.strokeText, v(a), b, c,
							d === void 0 ? Infinity : d)
				},
				...
				drawImage : function(a, b, c, d, f, g, o, l, z) {
					...
					m = v(m);
					if (q === 3)
						this.a.push(e.drawImage, q, m, b, c);
					else if (q === 5)
						this.a.push(e.drawImage, q, m, b, c, d, f);
					else if (q === 9) {
						if (d === 0 || f === 0)
							i(1);
			...
			var T = {
				...
				initElement : function(a) {
					...
					n[b] = 1;
					Q(a);
					a.innerHTML = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="'
							+ location.protocol
					...
					a.toDataURL = function(l, z) {
						("" + l).replace(/[A-Z]+/g, W) === "image/jpeg" ? o.a
								.push(e.toDataURL, l, typeof z === "number" ? z
