...
public class ProductDTO {
	...
	private Date pd_searchStartDate;
	private Date pd_searchEndDate;
	
	private String pd_mdmp_name;
	...
	public Date getPd_searchStartDate() {
		return pd_searchStartDate;
	}
	public void setPd_searchStartDate(Date pd_searchStartDate) {
		this.pd_searchStartDate = pd_searchStartDate;
	}
	public Date getPd_searchEndDate() {
		return pd_searchEndDate;
	}
	public void setPd_searchEndDate(Date pd_searchEndDate) {
		this.pd_searchEndDate = pd_searchEndDate;
	}
	public String getPd_mdmp_name() {
		return pd_mdmp_name;
	}
	public void setPd_mdmp_name(String pd_mdmp_name) {
		this.pd_mdmp_name = pd_mdmp_name;
	}
